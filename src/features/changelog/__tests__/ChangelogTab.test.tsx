...
describe('ChangelogTab', () => {
  ...
  it('renders versions in reverse chronological order', () => {
    ...
    expect(versionTexts[0]).toContain('0.27.13');
    expect(versionTexts[1]).toContain('0.27.12');
    expect(versionTexts[2]).toContain('0.27.11');
    expect(versionTexts[3]).toContain('0.27.10');
    expect(versionTexts[4]).toContain('0.27.9');
    expect(versionTexts[5]).toContain('0.27.8');
    expect(versionTexts[6]).toContain('0.27.7');
    expect(versionTexts[7]).toContain('0.27.6');
    expect(versionTexts[8]).toContain('0.27.5');
    expect(versionTexts[9]).toContain('0.27.4');
    expect(versionTexts[10]).toContain('0.27.3');
    expect(versionTexts[11]).toContain('0.27.2');
    expect(versionTexts[12]).toContain('0.27.1');
    expect(versionTexts[13]).toContain('0.27.0');
    expect(versionTexts[14]).toContain('0.26.1');
    expect(versionTexts[15]).toContain('0.26.0');
    expect(versionTexts[16]).toContain('0.25.0');
    expect(versionTexts[17]).toContain('0.24.0');
    expect(versionTexts[18]).toContain('0.23.1');
    expect(versionTexts[19]).toContain('0.23.0');
    expect(versionTexts[20]).toContain('0.22.2');
    expect(versionTexts[21]).toContain('0.22.1');
    expect(versionTexts[22]).toContain('0.22.0');
    expect(versionTexts[23]).toContain('0.21.1');
    expect(versionTexts[24]).toContain('0.21.0');
    expect(versionTexts[25]).toContain('0.20.1');
    expect(versionTexts[26]).toContain('0.20.0');
    // Last should be 1.0
