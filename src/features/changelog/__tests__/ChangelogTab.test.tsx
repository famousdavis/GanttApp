...
describe('ChangelogTab', () => {
  ...
  it('renders versions in reverse chronological order', () => {
    ...
    // First version heading should be 16.3, second 16.2, third 16.1, etc.
    expect(versionTexts[0]).toContain('16.3');
    expect(versionTexts[1]).toContain('16.2');
    expect(versionTexts[2]).toContain('16.1');
    // Last should be 1.0
