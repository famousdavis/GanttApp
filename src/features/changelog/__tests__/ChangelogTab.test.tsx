...
describe('ChangelogTab', () => {
  ...
  it('renders Version 5.5 entry', () => {
    render(<ChangelogTab />);
    expect(screen.getByText(/Version 5\.5/)).toBeTruthy();
  });
  ...
  it('renders versions in reverse chronological order', () => {
    ...
    // First version heading should be 5.5, second 5.4, etc.
    expect(versionTexts[0]).toContain('5.5');
    expect(versionTexts[1]).toContain('5.4');
    // Last should be 1.0
