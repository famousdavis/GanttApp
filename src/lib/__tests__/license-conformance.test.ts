 ...
 * before, and this repository was the worst of the nine.
 * It shipped **48 lines** — it did not carry the GNU GPL v3 at all, only a short
 * summary and a gnu.org hyperlink. None of the licence's 17 operative sections
 * were present: no patent grant, no warranty disclaimer, no preamble. GPL §4
 * requires giving recipients a copy of the licence; a link is a weak substitute.
 * The additional terms were also an older, weaker wording that omitted both the
 * ban on *replacing* the author attribution and the visible-UI-notice
 * requirement. Fixed in v0.27.14; spert-cfd was in comparable shape at 64 lines.
 *
...
const REPO_URL = 'https://github.com/famousdavis/GanttApp';
