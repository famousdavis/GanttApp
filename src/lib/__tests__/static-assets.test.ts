...
/**
 * The app hands users static files out of `public/` — the Quick Reference Guide PDF,
 * the favicons, and the served copy of the changelog. Nothing holds the link and the file together: rename or drop one of
 * them and the build passes, ESLint passes, every type check passes, and the
 * link 404s in the user's face.
 *
