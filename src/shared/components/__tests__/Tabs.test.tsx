...
describe('Tabs', () => {
  ...
  it('renders all four tabs', () => {
    render(<Tabs activeTab="projects" onTabChange={mockOnTabChange} />);
  ...
  it('calls onTabChange with "projects" when clicking Projects', () => {
    render(<Tabs activeTab="releases" onTabChange={mockOnTabChange} />);
  ...
  it('does not call onTabChange on initial render', () => {
    ...
    render(<Tabs activeTab="projects" onTabChange={freshMock} />);
