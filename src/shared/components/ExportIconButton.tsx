...
// Default color is grayscale; turns green on hover with a soft green ring. v0.23.1 (matches TrashIconButton pattern).
  ...
  return (
    <button
      ...
      style={{
        ...
        border: 'none',
        borderRadius: '6px',
        boxShadow: isHoverActive ? '0 0 0 1.5px rgba(16, 185, 129, 0.5)' : 'none',
