...
describe('ChangelogTab', () => {
  ...
  it('renders versions in reverse chronological order', () => {
    ...
    // First version heading should be 17.3.3, then 17.3.2, 17.3, 17.2, etc.
    expect(versionTexts[0]).toContain('17.3.3');
    expect(versionTexts[1]).toContain('17.3.2');
    expect(versionTexts[2]).toContain('17.3');
    // Last should be 1.0
